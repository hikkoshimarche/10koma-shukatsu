...
[both] 人の三井 — あなたで、世界中の未来をつくる。', 'あなたで、世界中の未来をつくる。', '売上14.7兆円 / 当期利益9,003億円 / 採用129名 / 1876年〜', NULL, '["[nana] ありがとうございました…1日同行、めちゃくちゃ濃かった。", "[haruki] 売上14.7兆円、当期利益9,003億円、採用129名。東洋経済『入社が難しい有名企業ランキング』で全国4位。", "[nana] でも評価で見るのは、3つの軸と『自分史』。", "[both] 人の三井 — あなたで、世界中の未来をつくる。"]', 'H1: スリーダイヤ社章 + H2: 大手町本社 朝の光', '{"location": "本社入口のサイン", "object_type": "スリーダイヤ社章 (三井のロゴ)", "brand_form": "本社入口の控えめなスリーダイヤとMITSUI & CO.の表記", "attachment": "本社外壁", "scale_note": "実在のサインの通常サイズ"}');
