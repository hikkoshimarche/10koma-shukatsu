...
[nana] 4,800億…
[haruki] 5大商社の中だと真ん中だけど、得意分野では世界トップクラス。
[nana] 真ん中の規模で、世界トップ? どこで?', '純利益4,800億円(2025年3月期)', '売上 約7兆円 / 9事業グループ', '公式IR', '["[haruki] 純利益4,800億円、売上7兆円。", "[nana] 4,800億…", "[haruki] 5大商社の中だと真ん中だけど、得意分野では世界トップクラス。", "[nana] 真ん中の規模で、世界トップ? どこで?"]', 'H1: 丸紅本社ビル (大手町)', '{"location": "本社ビル上部の外壁", "object_type": "建築サイン (Marubeni)", "brand_form": "ガラスファサード上部に『Marubeni』のサイン、控えめに", "attachment": "ビル外壁の建築サインとして固定", "scale_note": "実在の本社ビルと同じ控えめな比率"}');
...
[OB先輩] 倍率の話より、この3文字に合うかで決める。
[nana] (静かに) 9つのどこに行っても、その3文字が指針になるんだ…
[haruki] 分岐は怖くない。3文字が、進む方角を決めてくれる。', '見てるのは『正・新・和』', '倍率じゃない、3文字に合うか', NULL, '["[OB先輩] 丸紅が見るのは、『正・新・和』。正しい行動、新しい価値、和をもって事業に取り組むか。", "[OB先輩] 倍率の話より、この3文字に合うかで決める。", "[nana] (静かに) 9つのどこに行っても、その3文字が指針になるんだ…", "[haruki] 分岐は怖くない。3文字が、進む方角を決めてくれる。"]', 'H5: 緑の丸に紅字の社章 (再使用)', '{"location": "壁面中央", "object_type": "理念の3文字額または掲示", "brand_form": "『正・新・和』が縦書きで書かれた額、緑と白", "attachment": "壁面に固定", "scale_note": "実在の社内掲示の通常サイズ"}');
...
[nana] こんな未来、どれも私が選べる。3文字に従って。', '10年後、たとえばこんな場面', 'シカゴ / バンコク / 大手町(電話会議)', NULL, '["[nana] もし入れたら、10年後どこにいると思う?", "[haruki] たとえば、こんな未来。シカゴで小麦トレーディングをドル建てで動かしてる。", "[haruki] バンコクで太陽光IPPを着工。", "[haruki] 大手町本社でNYと電話会議しながら、新本部の設立を起案。", "[nana] こんな未来、どれも私が選べる。3文字に従って。"]', 'H4: 食品スーパーのパン棚 + H2 + H3 (3つの未来)', NULL);
...
[nana] 分岐は怖くない。3文字が、進む方角を決めてくれる。
[both] 正しく、新しく、和をもって。丸紅、9つの分岐から、世界へ。', '正しく、新しく、和をもって。', '売上 約7兆円 / 純利益 約4,800億円 / 採用77名', NULL, '["[haruki] 売上7兆円、純利益4,800億円、採用77名。", "[nana] 分岐は怖くない。3文字が、進む方角を決めてくれる。", "[both] 正しく、新しく、和をもって。丸紅、9つの分岐から、世界へ。"]', 'H1: 丸紅本社ビル (朝の光)', NULL);
