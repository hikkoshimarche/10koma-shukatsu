...
[nana] 約150年で、一社から世界へ展開していったってこと…', '1870年代、海運から始まった', '今 売上 約19兆円 / 10事業グループ', NULL, '["[haruki] 1870年代、岩崎弥太郎が土佐藩の船を引き継いで始めたのが海運業。", "[nana] スリーダイヤって、土佐藩主の家紋と岩崎家の家紋を合わせたんだって。", "[haruki] そう。海から始まって、今は10事業グループで売上19兆円。", "[nana] 約150年で、一社から世界へ展開していったってこと…"]', 'H7: 三菱マーク入りコンテナと港湾', '{"location": "中景のコンテナ複数の側面", "object_type": "三菱マーク (スリーダイヤ)", "brand_form": "赤いスリーダイヤがコンテナ側面に印刷", "attachment": "コンテナの塗装の一部", "scale_note": "実在のコンテナと同じ控えめな比率"}');
...
[nana] LNG?
[haruki] 液化天然ガスのこと。現在は世界14のプロジェクトに参画している。日本の電力の3割が、これに支えられてる。
[nana] 私の家のガスも電気も、夜中にこのタンカーが運んでるんだ…', '1969年、日本のエネルギーを変えた', '世界14のLNGプロジェクト / 日本の電力の3割を支える', NULL, '["[haruki] 1969年、アラスカからLNG輸入を始めた。日本企業初。", "[nana] LNG?", "[haruki] 液化天然ガスのこと。現在は世界14のプロジェクトに参画している。日本の電力の3割が、これに支えられてる。", "[nana] 私の家のガスも電気も、夜中にこのタンカーが運んでるんだ…"]', 'H3: LNGタンカー (夜の海上)', NULL);
...
[OB先輩] 第一希望そのまま通る人は半分くらい。まず、希望通りとは限らないと思っておいた方がいい。
[OB先輩] そのうえで、10事業グループのどこに行くかで仕事が全く違う。資源系はオーストラリア・中東、コンシューマーはアジアで、入社3〜7年で海外駐在に出る人が多い。
[haruki] 希望が通るかどうか以前に、どのグループで何をやり抜く覚悟があるか、そこが問われるってことか…', '希望通りとは限らない、10事業グループ。', '第一希望が通るのは半分 / グループで仕事は全く変わる', NULL, '["[nana] 配属って、希望通りに行けるんですか?", "[OB先輩] 第一希望そのまま通る人は半分くらい。まず、希望通りとは限らないと思っておいた方がいい。", "[OB先輩] そのうえで、10事業グループのどこに行くかで仕事が全く違う。資源系はオーストラリア・中東、コンシューマーはアジアで、入社3〜7年で海外駐在に出る人が多い。", "[haruki] 希望が通るかどうか以前に、どのグループで何をやり抜く覚悟があるか、そこが問われるってことか…"]', 'H6: 海外拠点 (NY・シンガポール・ロンドンのオフィスファサード)', NULL);
...
INSERT OR REPLACE INTO company_panels (company_id, panel_num, image_url, character, dialogue, main_copy, sub_copy, source_url, script_json, visual_hook, brand_object_json) VALUES ('mitsubishi-corp', 9, 'https://cdn.jsdelivr.net/gh/hikkoshimarche/10koma-shukatsu@29041ca/public/images/mitsubishi-corp/panel_09.png', 'nana', '[OB先輩] 三菱が見るのは、『芯』『共創力』『高い志と誠実性』。学歴やスペックじゃない。
