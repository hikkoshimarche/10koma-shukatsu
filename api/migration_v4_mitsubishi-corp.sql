...
[haruki] 希望が通るかどうか以前に、どのグループで何を10年やる覚悟があるか、そこが問われるってことか…', '希望通りとは限らない、10事業グループ。', '第一希望が通るのは半分 / グループで仕事は全く変わる', NULL, '["[nana] 配属って、希望通りに行けるんですか?", "[OB先輩] 第一希望そのまま通る人は半分くらい。まず、希望通りとは限らないと思っておいた方がいい。", "[OB先輩] そのうえで、10事業グループのどこに行くかで仕事が全く違う。資源系はオーストラリア・中東、コンシューマーはアジアで、入社3〜7年で海外駐在に出る人が多い。", "[haruki] 希望が通るかどうか以前に、どのグループで何を10年やる覚悟があるか、そこが問われるってことか…"]', 'H6: 海外拠点 (NY・シンガポール・ロンドンのオフィスファサード)', NULL);
