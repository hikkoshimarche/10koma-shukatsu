...
INSERT OR REPLACE INTO company_panels (company_id, panel_num, image_url, character, dialogue, main_copy, sub_copy, source_url, script_json, visual_hook, brand_object_json) VALUES ('mitsubishi-corp', 1, 'https://cdn.jsdelivr.net/gh/hikkoshimarche/10koma-shukatsu@29041ca/public/images/mitsubishi-corp/panel_01.png', 'nana', '[nana] 丸の内、なんで三菱の建物だらけなんだろ?
[haruki] あ、本当だ。三菱地所、三菱UFJ、三菱重工、三菱商事…
[nana] みんな『三菱村』って呼んでるらしい。
[haruki] それ、150年前から続いてるって知ったら、見方変わるかも。', '丸の内、なんで三菱村?', '三菱商事 / 8058 / 150年の起点', NULL, '["[nana] 丸の内、なんで三菱の建物だらけなんだろ?", "[haruki] あ、本当だ。三菱地所、三菱UFJ、三菱重工、三菱商事…", "[nana] みんな『三菱村』って呼んでるらしい。", "[haruki] それ、150年前から続いてるって知ったら、見方変わるかも。"]', 'H1: 丸の内パークビルディング本社 (赤いスリーダイヤサイン)', '{"location": "丸の内パークビルディング本社上部の外壁", "object_type": "建築サイン (社名+三菱マーク)", "brand_form": "赤いスリーダイヤと『三菱商事』の漢字サイン、ビル外壁に控えめなサイズで設置", "attachment": "ビル外壁の建築サインとして固定", "scale_note": "実在の本社ビルと同じ控えめな比率"}');
INSERT OR REPLACE INTO company_panels (company_id, panel_num, image_url, character, dialogue, main_copy, sub_copy, source_url, script_json, visual_hook, brand_object_json) VALUES ('mitsubishi-corp', 2, 'https://cdn.jsdelivr.net/gh/hikkoshimarche/10koma-shukatsu@29041ca/public/images/mitsubishi-corp/panel_02.png', 'haruki', '[haruki] 1870年代。岩崎弥太郎が土佐藩の船を引き継いで始めた海運業。
[nana] スリーダイヤって、土佐藩主の家紋と岩崎家の家紋を合わせたんだって。
[haruki] そう。海から始まって、今は10事業グループで売上19兆円。
[nana] 150年で、海運1社が、世界の動脈になったってこと…', '1870年代、海運から始まった', '今 売上 約19兆円 / 10事業グループ', NULL, '["[haruki] 1870年代。岩崎弥太郎が土佐藩の船を引き継いで始めた海運業。", "[nana] スリーダイヤって、土佐藩主の家紋と岩崎家の家紋を合わせたんだって。", "[haruki] そう。海から始まって、今は10事業グループで売上19兆円。", "[nana] 150年で、海運1社が、世界の動脈になったってこと…"]', 'H7: 三菱マーク入りコンテナと港湾', '{"location": "中景のコンテナ複数の側面", "object_type": "三菱マーク (スリーダイヤ)", "brand_form": "赤いスリーダイヤがコンテナ側面に印刷", "attachment": "コンテナの塗装の一部", "scale_note": "実在のコンテナと同じ控えめな比率"}');
INSERT OR REPLACE INTO company_panels (company_id, panel_num, image_url, character, dialogue, main_copy, sub_copy, source_url, script_json, visual_hook, brand_object_json) VALUES ('mitsubishi-corp', 3, 'https://cdn.jsdelivr.net/gh/hikkoshimarche/10koma-shukatsu@29041ca/public/images/mitsubishi-corp/panel_03.png', 'nana', '[nana] これ、90年前にできた指針なんだって。三綱領。
[haruki] 所期奉公・処事光明・立業貿易。事業で社会に奉公、公明正大、世界視野。
[nana] 90年前の3文字が、今の19兆円を動かしてるんだ…
[haruki] 言葉が古びてない、ってデカいことだよ。', '1934年から変わらない、3文字', '所期奉公 / 処事光明 / 立業貿易', NULL, '["[nana] これ、90年前にできた指針なんだって。三綱領。", "[haruki] 所期奉公・処事光明・立業貿易。事業で社会に奉公、公明正大、世界視野。", "[nana] 90年前の3文字が、今の19兆円を動かしてるんだ…", "[haruki] 言葉が古びてない、ってデカいことだよ。"]', 'H5: 三綱領の額・石碑', '{"location": "ロビー壁面の中央", "object_type": "理念の額 (書道作品の額装)", "brand_form": "『所期奉公 / 処事光明 / 立業貿易』が縦書きで書かれた書、木製の額装", "attachment": "壁面に固定された額", "scale_note": "実在の社内額の通常サイズ"}');
