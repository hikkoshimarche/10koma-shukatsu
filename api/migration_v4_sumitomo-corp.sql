...
[haruki] 派手じゃないけど、毎日の中にいる。それが住友の強さ。', '毎日の中に、住友がいる', 'ヤマザキビスケット / TBS / J:COM / SCSK / メルカリ', NULL, '["[nana] このスナックも…ヤマザキビスケットって、住友の子会社なの?", "[haruki] そう。TBSも関連会社。テレビと、お菓子と、リモコンと、SCSKと…", "[nana] 私の1日、住友商事の中をぐるっと回ってる…", "[haruki] 派手じゃないけど、毎日の中にいる。それが住友の強さ。"]', 'H3: ヤマザキビスケット商品 (+ H4: TBS赤坂)', '{"location": "中央の商品パッケージ", "object_type": "ヤマザキロゴ", "brand_form": "『Yamazaki』の商品パッケージロゴ、実在の意匠", "attachment": "商品パッケージに印刷", "scale_note": "実在の商品と同じサイズ"}');
INSERT OR REPLACE INTO company_panels (company_id, panel_num, image_url, character, dialogue, main_copy, sub_copy, source_url, script_json, visual_hook, brand_object_json) VALUES ('sumitomo-corp', 9, 'https://cdn.jsdelivr.net/gh/hikkoshimarche/10koma-shukatsu@9e93cbf/public/images/sumitomo-corp/panel_09.png', 'haruki', '[nana] もし入れたら、10年後どこにいると思う?
[haruki] たとえば、こんな未来。ドバイの発電所で電力PPA交渉。
[haruki] 大手町本社でJ:COMのアジア展開を企画。
[haruki] 愛媛の別子銅山跡で、400年の発祥地のリニューアル事業。
[nana] 派手じゃないけど、深く広い。どれも、長く残る仕事。', '10年後、たとえばこんな場面', 'ドバイ / 大手町 / 別子銅山跡(愛媛)', NULL, '["[nana] もし入れたら、10年後どこにいると思う?", "[haruki] たとえば、こんな未来。ドバイの発電所で電力PPA交渉。", "[haruki] 大手町本社でJ:COMのアジア展開を企画。", "[haruki] 愛媛の別子銅山跡で、400年の発祥地のリニューアル事業。", "[nana] 派手じゃないけど、深く広い。どれも、長く残る仕事。"]', 'H6: 海外発電プラント (再使用)', NULL);
