...
[nana] 当たり前すぎて気づいてなかったけど、私の朝、岩谷だらけだったんだ…', '鍋・キャンプ・災害備蓄も', 'カセットボンベ / 50年以上', NULL, '["[haruki] このカセットボンベも、ぜんぶイワタニだ。", "[nana] え、これも?", "[haruki] うん、50年以上のロングセラー。鍋もキャンプも、災害備蓄も、ぜんぶイワタニのボンベ。", "[nana] 当たり前すぎて気づいてなかったけど、私の朝、岩谷だらけだったんだ…"]', 'H2: イワタニのカセットボンベ', '{"location": "カセットボンベ本体側面", "object_type": "ブランドロゴ (Iwatani)", "brand_form": "銀色の缶にオレンジ色で『Iwatani』ロゴ、実在のデザイン", "attachment": "缶に印刷", "scale_note": "実在のカセットボンベ通常サイズ"}');
...
[haruki] うん、マルヰガス。日本最大のLPGブランド。
[nana] 約340万世帯がこれを使ってるって。
[haruki] 都市ガスが届かない地域は、ほぼマルヰガス。岩谷が日本の家庭の動脈の半分を担ってる。', 'マルヰガス、約340万世帯', '日本最大のLPGブランド', NULL, '["[nana] ねえ、このタンク、見たことある。", "[haruki] うん、マルヰガス。日本最大のLPGブランド。", "[nana] 約340万世帯がこれを使ってるって。", "[haruki] 都市ガスが届かない地域は、ほぼマルヰガス。岩谷が日本の家庭の動脈の半分を担ってる。"]', 'H3: マルヰガスのLPGボンベ (一軒家の外壁横)', '{"location": "LPGタンクの正面", "object_type": "マルヰマーク (LPGブランド)", "brand_form": "丸の中に『マ』の字、赤と白", "attachment": "タンク正面に印刷", "scale_note": "実在のLPGタンクの通常マーク"}');
...
[nana] (静かに) カセットコンロからオリンピック聖火まで、ぜんぶ『世のため人のため』なんだ…
[haruki] 派手じゃないけど、誰かの今日を温める仕事、ってことだね。', '見てるのは『世のため人のため』', '倍率より、誰かの今日を温める覚悟', NULL, '["[OB先輩] 岩谷が見るのは、『世のため人のため』を体現できる人。", "[OB先輩] 倍率は30〜50倍だけど、見てるのはエネルギーで誰かの生活を支える覚悟があるか。", "[nana] (静かに) カセットコンロからオリンピック聖火まで、ぜんぶ『世のため人のため』なんだ…", "[haruki] 派手じゃないけど、誰かの今日を温める仕事、ってことだね。"]', NULL, NULL);
