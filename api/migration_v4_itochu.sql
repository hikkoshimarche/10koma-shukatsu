...
[haruki] 150年前の近江商人と、今の私たちが、同じ姿勢で立ってる、ってこと。', 'ひとりの商人、無数の使命', '倍率じゃない、自分で使命を持てる人', NULL, '["[OB先輩] 伊藤忠が見るのは、『ひとりの商人、無数の使命』。目立つ経験ではなく、ひとりの商人として活躍できるか。", "[OB先輩] 一人ひとりが、自分で使命を見つけて動けるか。", "[nana] (静かに) 上から指示される会社じゃないんだ…", "[haruki] 150年前の近江商人と、今の私たちが、同じ姿勢で立ってる、ってこと。"]', 'H7: 本社の光庭 (吹き抜けの自然光)', NULL);
