...
INSERT OR REPLACE INTO company_panels (company_id, panel_num, image_url, character, dialogue, main_copy, sub_copy, source_url, script_json, visual_hook, brand_object_json) VALUES ('itochu', 1, 'https://cdn.jsdelivr.net/gh/hikkoshimarche/10koma-shukatsu@2630894/public/images/itochu/panel_01.png', 'nana', '[nana] これ、ファミマで買ったTシャツ。なんで商社の話で出てくるんだろう?
[haruki] え、ファミマって自分で企画してるんじゃないの?
[nana] そう思ってたんだけど、違うらしくて…
[haruki] 実は、ファミマで売ってる『Convenience Wear』は、伊藤忠の繊維カンパニーが企画してるんだ。', 'コンビニのTシャツ、誰が企画?', '伊藤忠商事 / 8001', NULL, '["[nana] これ、ファミマで買ったTシャツ。なんで商社の話で出てくるんだろう?", "[haruki] え、ファミマって自分で企画してるんじゃないの?", "[nana] そう思ってたんだけど、違うらしくて…", "[haruki] 実は、ファミマで売ってる『Convenience Wear』は、伊藤忠の繊維カンパニーが企画してるんだ。"]', 'H3: Convenience Wear (ファミマ店内のアパレル売り場)', '{"location": "商品棚のヘッダーまたは商品タグ", "object_type": "PB ブランドサイン", "brand_form": "『Convenience Wear』のロゴ (シンプルなセリフ体)、棚ヘッダーに控えめに表示", "attachment": "棚に取り付けられたブランドヘッダー", "scale_note": "実在のファミマ店舗の通常サイズ"}');
...
[haruki] ベース+海外駐在手当+コンシューマー部門の業績連動。ファミマが伸びたら、繊維カンパニーの賞与にも反映する。
[nana] 自分が動かした事業の結果が、年収に返ってくるんだ。', '1,805万円(平均)+業績連動', 'ベース / 海外駐在 / コンシューマー連動', '日経会社情報 8001 / 有報', '["[nana] 伊藤忠の年収って、いくらなの?", "[haruki] 平均1,805万円。でも、構造で見るのが大事。", "[haruki] ベース+海外駐在手当+コンシューマー部門の業績連動。ファミマが伸びたら、繊維カンパニーの賞与にも反映する。", "[nana] 自分が動かした事業の結果が、年収に返ってくるんだ。"]', NULL, NULL);
...
[nana] 街に馴染んでる感じ…
[haruki] でも2026年8月、新本社に移転する。青山時代の45年を、自分たちで締めくくった。
[nana] 建物も人も、続いて、変わる。', '青山45年 → 2026年8月、新本社へ', '1980年竣工 / 雁行配置 / マホガニー・レッド', NULL, '["[haruki] 青山本社、1980年竣工。マホガニー・レッドの外装は45年変わってない。", "[nana] 街に馴染んでる感じ…", "[haruki] でも2026年8月、新本社に移転する。青山時代の45年を、自分たちで締めくくった。", "[nana] 建物も人も、続いて、変わる。"]', 'H1: 北青山の伊藤忠商事東京本社ビル', '{"location": "本社ビル上部の外壁", "object_type": "建築サイン (ITOCHU)", "brand_form": "ビル上部にレリーフ調の『ITOCHU』サイン、控えめに", "attachment": "ビル外壁の建築サインとして固定", "scale_note": "実在の本社ビルと同じ控えめな比率"}');
...
INSERT OR REPLACE INTO company_panels (company_id, panel_num, image_url, character, dialogue, main_copy, sub_copy, source_url, script_json, visual_hook, brand_object_json) VALUES ('itochu', 9, 'https://cdn.jsdelivr.net/gh/hikkoshimarche/10koma-shukatsu@2630894/public/images/itochu/panel_09.png', 'nana', '[OB先輩] 伊藤忠が見るのは、『ひとりの商人、無数の使命』。倍率じゃない。
[OB先輩] 一人ひとりが、自分で使命を見つけて動けるか。
[nana] (静かに) 上から指示される会社じゃないんだ…
[haruki] 150年前の近江商人と、今の私たちが、同じ姿勢で立ってる、ってこと。', 'ひとりの商人、無数の使命', '倍率じゃない、自分で使命を持てる人', NULL, '["[OB先輩] 伊藤忠が見るのは、『ひとりの商人、無数の使命』。倍率じゃない。", "[OB先輩] 一人ひとりが、自分で使命を見つけて動けるか。", "[nana] (静かに) 上から指示される会社じゃないんだ…", "[haruki] 150年前の近江商人と、今の私たちが、同じ姿勢で立ってる、ってこと。"]', 'H7: 本社の光庭 (吹き抜けの自然光)', NULL);
...
[nana] 数字じゃなくて、世界のどんな商売を私が動かすか、ってことだね。
[both] **売り手よし、買い手よし、世間よし — 150年前の近江から、世界へ。**', '150年前の近江から、世界へ。', '売上14.7兆円 / 純利益8,803億円(過去最高) / 採用129名', NULL, '["[haruki] 売上14.7兆円、純利益8,803億円(過去最高)、採用129名。", "[nana] 数字じゃなくて、世界のどんな商売を私が動かすか、ってことだね。", "[both] **売り手よし、買い手よし、世間よし — 150年前の近江から、世界へ。**"]', 'H6: 繊維倉庫の反物 (締めの象徴)', NULL);
