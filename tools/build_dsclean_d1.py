...
生成物: .backups/pre_dsclean_<ts>.sql と scratchpad/dsclean_update.sql"""
...
BACKUP = os.path.join(ROOT, ".backups", f"pre_dsclean_{TS}.sql")
UPD = "/private/tmp/claude-501/-Users-oscardodds-projects-10koma-shukatsu/7bb93f17-be86-4a51-a16e-c0b146625361/scratchpad/dsclean_update.sql"
...
changed = [r.split(",")[0] for r in open(os.path.join(OUT, "es_clean_changed.csv")) if r.strip()]
