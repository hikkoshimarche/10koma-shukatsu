...
TS=$(date +%Y%m%d_%H%M)
python3 tools/build_company_selection.py "$TS" >> /tmp/selection_monthly.log 2>&1
INS=/private/tmp/claude-501/-Users-oscardodds-projects-10koma-shukatsu/7bb93f17-be86-4a51-a16e-c0b146625361/scratchpad/company_selection.sql
